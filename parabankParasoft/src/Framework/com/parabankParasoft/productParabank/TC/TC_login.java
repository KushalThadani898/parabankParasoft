...
@AfterMethod
	...
	public void tc_01_validate_parabank_login(@Optional("firefox") String browser_name,@Optional("")String url) throws IOException{
		try {
	...
	@Test(groups= {"smoke","regression"})
	public void tc_02_validate_parabank_login_with_wrong_username(@Optional("firefox") String browser_name,@Optional("")String url) throws IOException{
		try{
			BrowserManager oBrowserManager = new BrowserManager();
			WebDriver driver = oBrowserManager.GetBrowser(browser_name);
			oBrowserManager.NavigateToPage(driver, url);
	...
	//@Test(groups= {"smoke","regression"}Priority=1)
	@Test(groups= {"smoke","regression"})
	public void tc_03_validate_parabank_login_with_blank_pasword(@Optional("firefox") String browser_name,@Optional("")String url) throws IOException{
		try{
			BrowserManager oBrowserManager = new BrowserManager();
			WebDriver driver = oBrowserManager.GetBrowser(browser_name);
			oBrowserManager.NavigateToPage(driver, url);
	...
	//@Test(groups= {"smoke","regression"}Priority=1)
	@Test(groups= {"smoke","regression"})
	public void tc_04_validate_parabank_login_with_blank_username(@Optional("firefox") String browser_name,@Optional("")String url) throws IOException{
		try{
			BrowserManager oBrowserManager = new BrowserManager();
			WebDriver driver = oBrowserManager.GetBrowser(browser_name);
			oBrowserManager.NavigateToPage(driver, url);
	...
	//@Test(groups= {"smoke","regression"}Priority=1)
	@Test(groups= {"smoke","regression"})
	public void tc_05_validate_parabank_login_with_wrong_password(@Optional("firefox") String browser_name,@Optional("")String url) throws IOException{
		try{
			BrowserManager oBrowserManager = new BrowserManager();
			WebDriver driver = oBrowserManager.GetBrowser(browser_name);
			oBrowserManager.NavigateToPage(driver, url);
